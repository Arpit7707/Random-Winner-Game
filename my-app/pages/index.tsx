...
export default function Home() {
  ...
  const checkIfGameStarted = async ()=>{
    try {
      ...
      if(_gameStarted){
        _logs= [`Game started with gameId ${_game.id}`]
  ...
  //we can't make this function async coz this will be called in JSX
  //and if we add async this will be "promise" and promises are invalid as react child
  const renderButton = ()=>{
